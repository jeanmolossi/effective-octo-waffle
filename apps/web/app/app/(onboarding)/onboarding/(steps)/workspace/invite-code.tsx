	...
	return (
		<div className="space-y-4">
			...
			<div className="mb-4 animate-slide-up-fade [animation-delay:100ms] [animation-duration:1s] [animation-fill-mode:both]">
				<Label>Codigo de convite <span className="text-red-500">*</span></Label>
				<Input placeholder="7c6c6e88b17f0c20c95f54c7d6986ab7ab7d9eeb04e8803352ddeaea48015a39" required />
				<small className="italic text-muted-foreground">Você recebe o código acima via e-mail</small>
			</div>
		</div>
	)
}
